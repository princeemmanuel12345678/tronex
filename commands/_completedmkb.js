...
let hmokkka=mokkka1/100
let mokka10=hmokkka*1
var byt=[{title:"Track Transactions",url: "t.me/tradeopays"}]
...
if(amount>=mnm){
let peh=amount*mokka10

Bot.run( {
    command:'/adc'+' '+peh+' '+relg75.value()+' '+amount+' '+options.currency+' '+'dep',
...
var Lang = {
    'amount' : amount+" "+options.currency,
